...
Y_2(t_0)=1&Y_2'(t_0)=1&\ldots&Y_1^{(n-1)}(t_0)=0\\
\vdots&\vdots&\ddots&\vdots&\\
Y_n(t_0)=0&Y_1'(t_0)=0&\ldots&Y_1^{(n-1)}(t_0)=1\\
\end{array}
\end{equation}$$
...
1. Solving $$n$$ problems individually: Requires solving $$n$$ $$n$$-th order initial value problems. This includes evaluating $$n^2-n$$ derivatives and solving $$n$$ systems of $$n$$ equations with $$n$$ variables.
